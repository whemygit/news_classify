...
def requests_post_1(data):
    # resp = requests.post('http://192.168.0.249:8080/cityparlor-web/cityparlor/cityparlor/top/news/add', data=data)
...
def get_info(city):
    ...
    # city, date_n)
    sql = '''SELECT * FROM rec_news_data WHERE newsid=395413;'''
    res = db.query(sql)
