...
areas = ['石家庄市', '太原市', '呼和浩特市', '唐山市', '大同市', '包头市', '秦皇岛市', '阳泉市', '乌海市', '邯郸市',
         '长治市', '赤峰市', '邢台市', '晋城市', '呼伦贝尔市', '保定市', '朔州市', '通辽市', '张家口市', '忻州市', '乌兰察布市', '承德市', '吕梁市', '鄂尔多斯市', '沧州市',
         '晋中市', '巴彦淖尔市', '廊坊市', '临汾市', '衡水市', '运城市', '长春市', '哈尔滨市', '吉林市', '齐齐哈尔市', '四平市', '牡丹江市',
         '辽源市', '佳木斯市', '通化市', '大庆市', '白山市', '伊春市', '白城市', '鸡西市', '松原市', '鹤岗市',
         '双鸭山市', '七台河市', '绥化市', '黑河市', '南京市', '杭州市', '合肥市', '福州市', '南昌市',
         ...
         '雅安市', '广安市', '巴中市', '眉山市', '西安市', '兰州市', '西宁市', '乌鲁木齐市', '铜川市', '嘉峪关市', '海东市', '石嘴山市', '克拉玛依市', '宝鸡市',
