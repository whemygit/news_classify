...
if __name__ == '__main__':
    ...
    try:
        os.mkdir('/home/spider/img_down/img')
    except OSError, e:
        if e.errno == 17:  # 如果是文件已经存在，则不做任何操作
            ...
            print e
            sys.exit()
    os.chdir('/home/spider/img_down/img')
    urls = []
    with open('/home/spider/img_down/src', 'r') as fr:
        urls = [src.strip() + '.jpeg' for src in fr.readlines()]
